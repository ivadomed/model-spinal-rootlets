...
def get_parser():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help='Path to the data_processed folder with CSV files for individual subjects and method of level estimation '
             'generated by the'
             'inter-rater_variability/02a_rootlets_vertebrae_spinal_levels.py script or '
             'pediatric_rootlets/discs_to_vertebral_levels.py.'
...
def calculate_overlap(df):
    ...
    df_overlap = pd.DataFrame({'subject': list_subjects, 'spinal_level': list_levels_num,
                               'spinal_level_name': list_levels, 'overlap': list_overlap,
                               'sex': list_sex, 'age': list_age})
