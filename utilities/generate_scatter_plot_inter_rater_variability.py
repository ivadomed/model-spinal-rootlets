...
def generate_figure(df, dir_path):
    ...
    # Add title
    ax.set_title('Spinal Level Inter-Rater Variability - F1 Score', y=1.03)
    ...
    # Save the figure
    fname_figure = 'scatter_plot_inter_rater_variability.png'
...
def main():
    ...
    # Get all the CSV files in the directory generated by the compute_f1_and_dice.py script
