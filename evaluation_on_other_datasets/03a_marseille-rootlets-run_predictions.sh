#!/bin/bash
#
# The script runs our nnUNet model on a 10 subjects (2 sessions) from the marseille-rootlets dataset (private) to
# evaluate the inter-session stability.
#
# Namely:
...
#
# Usage:
#       sct_run_batch -script 03a_marseille-rootlets-run_predictions.sh
#                     -path-data <DATA>
